              ...
              {workouts.map((w, i) => (
                <tr key={w.id || i}>
                  ...
                  <td>
                    ...
                    <a className="btn btn-sm btn-link" href={`https://${process.env.REACT_APP_CODESPACE_NAME}-8000.app.github.dev/api/workouts/${w.id || ''}`} target="_blank" rel="noreferrer">API</a>
                  </td>
                </tr>
              ))}
              {workouts.length === 0 && (
